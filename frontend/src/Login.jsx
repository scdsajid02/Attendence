...
const Login = ({ setToken }) => {
  ...
  return showOtp === false ? (
    <div className="flex  items-center justify-center h-[97vh] lg:rounded-2xl rounded-xl px-6 sm:px-0 bg-gradient-to-l from-slate-500 to-blue-500">
    ...
    <div className="flex items-center justify-center h-[97vh] px-6 lg:rounded-2xl rounded-xl sm:px-0 bg-gradient-to-l from-slate-500 to-blue-500">
      <h1 className="absolute left-5 sm:left-20 top-5 font-bold rubik text-3xl cursor-pointer text-red-600">
        RED <span className="text-black">CLOUD</span>
      </h1>
      <form
